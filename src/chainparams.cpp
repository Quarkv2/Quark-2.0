...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
        boost::assign::map_list_of
        ( 0, uint256("0x00000bcefa5de983c850b8abf92fc282a51ad815757dbead7ba071f36260a134"))
        ;
...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("seed1.quark2.xyz", "seed1.quark2.xyz"));
        vSeeds.push_back(CDNSSeedData("seed2.quark2.xyz", "seed2.quark2.xyz"));
        vSeeds.push_back(CDNSSeedData("seed3.quark2.xyz", "seed3.quark2.xyz"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testseed1.quark2.xyz", "testseed1.quark2.xyz"));
